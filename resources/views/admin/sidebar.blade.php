                ...
                <div class="app-sidebar">
                    ...
                    <div class="main-sidemenu">
                        ...
                        <ul class="side-menu">
                            ...
                            <li class="slide">
                                <a class="side-menu__item" data-bs-toggle="slide" href="{{url('/categories')}}"><i
                            ...
                            <li class="slide">
								...
								<ul class="slide-menu">
									<li class="panel sidetab-menu">
										<div class="p-0 pb-2 border-0 tab-menu-heading">
											<div class="tabs-menu ">
												<!-- Tabs -->
										...
										<div class="p-0 border-0 panel-body tabs-menu-body">
											<div class="tab-content">
												<div class="tab-pane active" id="side9">
                                                    ...
                                                    <div class="p-0 mt-5 menutabs-content">
                                                        <div class="Annoucement_card">
                                                            <div class="text-center">
                                                                <div>
                                                                    <h5 class="mt-0 mb-1 title ms-2 font-weight-bold tx-12"> Go for Premium Account </h5>
                                                                    <div class="bg-layer">
                                                                        <img src="../assets/../assets/images/media/37.png" alt="img" class="mx-auto text-center">
                                                                    </div>
                                                                    <p class="my-2 mt-0 mb-0 text-center subtext ms-2 fs-13"> $399.9 /Monthly</p>
                                                                </div>
                                                            </div>
                                                            <button class="mt-4 btn btn-block btn-primary fs-14"> Upgrade</button>
                                                        </div>
                                                    </div>
												</div>
												<div class="tab-pane" id="side10">
													<h5 class="mt-3 mb-4 fw-600">Recent Chats</h5>
                                                    <div class="main-chat-list tab-pane">
                                                        <div class="px-1 border-0 media new border-top-0">
                                                        ...
                                                        <div class="px-1 border-0 media new">
                                                        ...
                                                        <div class="px-1 border-0 media new border-bottom-0">
